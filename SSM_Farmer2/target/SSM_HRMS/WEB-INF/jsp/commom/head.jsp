    ...
    <nav class="navbar navbar-inverse navbar-static-top">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" id="company_logo" href="#">草滩国际金融公司</a>
            </div>

            <div class="collapse navbar-collapse" id="hrms-navbar-collapse-1">
                <ul class="nav navbar-nav">
                    <%--<li class="active"><a href="#">公司介绍 <span class="sr-only">(current)</span>  </a>--%>
                    <%--</li>--%>
                        <li role="presentation"><a href="#" class="company_info" >公司介绍</a></li>
...
<script type="text/javascript">
    ...
    $(".company_info").click(function () {
        $(this).attr("href","/hrms/companyinfo");
    })
</script>
</body>
</html>
